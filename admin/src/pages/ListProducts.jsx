    ...
    <>
      <div className="flex justify-between items-center flex-wrap  mb-6  gap-4">
        ...
        <input
          ...
          className="px-4 py-2  shadow-sm bg-white  rounded-md w-full md:w-96 focus:outline-none focus:shadow-2xl focus:shadow-gray-500 focus:border-gray-500 transition"
        />
