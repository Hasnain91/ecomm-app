      ...
      {isLoading ? (
        ...
        <div>
          {users.map((user, index) => (
            <div
              className="flex flex-col sm:flex-row  gap-3 items-center justify-around border-2 border-gray-500 p-5 md:p-8 my-3 md:my-4 text-sm sm:text-base text-gray-700 place-items-center"
              key={index}
            >
